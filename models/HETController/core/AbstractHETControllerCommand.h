/*
AbstractHETControllerCommand.h
!CHAOS
...
*/
#ifndef __AbstractHETControllerCommand__
#define __AbstractHETControllerCommand__
#include "HETControllerConstants.h"
...
#include <driver/MultiChannelPowerSupply/core/MultiChannelPowerSupplyConstants.h>
...
namespace driver {
	namespace hetcontroller{
		class AbstractHETControllerCommand: public ccc_slow_command::SlowCommand {
		public:
