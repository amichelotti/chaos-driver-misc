...
*/
#ifndef __HETController__SCHETControllerControlUnit__
#define __HETController__SCHETControllerControlUnit__
...
namespace driver {
	namespace hetcontroller {
		class SCHETControllerControlUnit: public chaos::cu::control_manager::SCAbstractControlUnit {
			PUBLISHABLE_CONTROL_UNIT_INTERFACE(SCHETControllerControlUnit)
			std::string device_hw;
			chaos::driver::hetcontroller::ChaosHETControllerInterface *hetcontroller_drv;
		...
		public:
			...
			SCHETControllerControlUnit(const std::string& _control_unit_id,const std::string& _control_unit_param,const ControlUnitDriverList& _control_unit_drivers);
			/*Base Destructor*/
			~SCHETControllerControlUnit();
		};
	}
}
#endif
