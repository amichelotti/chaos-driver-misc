...
*/
#ifndef __HETPic__SCHETPicControlUnit__
#define __HETPic__SCHETPicControlUnit__
...
namespace driver {
	namespace hetpic {
		class SCHETPicControlUnit: public chaos::cu::control_manager::SCAbstractControlUnit {
			PUBLISHABLE_CONTROL_UNIT_INTERFACE(SCHETPicControlUnit)
