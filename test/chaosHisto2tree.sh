...
chaosHisto2tree --log-max-size 200 --metadata-server "$1" --log-on-file 1 --start "$2" --end "$3" --page 1000 --log-file CHAOSHISTO.log --nodeid "$4" --direct-io-client-kv-param=ZMQ_RCVTIMEO:600000
